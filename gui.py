...
class Interface:
    def __init__(self, master):
        ...
        self.song_listbox = Listbox(self.section1, width=80, height=10, bg="antiquewhite")  # Ajuster la taille ici
        ...
        self.path_lab2 = Label(self.path_label2, text="", width=10, height=1, justify="left", bg="lightyellow")
